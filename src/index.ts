...
diff_match_patch.prototype.diff_lineMode = function diff_lineMode(text1: string, text2: string) {
...
diff_match_patch.prototype.diff_wordMode = function diff_wordMode(text1: string, text2: string) {
...
diff_match_patch.prototype.diff_wordsToChars_ = function diff_wordsToChars_(
  text1: string,
  text2: string,
) {
